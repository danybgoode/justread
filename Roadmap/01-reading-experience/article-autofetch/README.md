...
- [x] All sprints merged to `main` (PR #10, `0825cd5`) + deployed via `update.sh` + smoke-tested. The gaps are stated in each sprint: signed-in browser steps are owed to the product owner
- [x] Each `sprint-N.md` has its smoke walkthrough (real URLs) and the measured numbers
- [x] This README marked ✅; every sprint status ticked with commit refs
- [x] `RETROSPECTIVE.md` written
- [x] Product poster updated — 01's "Original-content fetching" line goes 🚧 → ✅
- [x] Durable learnings promoted to `Roadmap/LEARNINGS.md`
- [x] **Kill switch:** D4's env vars turned off and back on in production, 2026-09-15 21:08 UTC. With them off, the container read the empty values, and neither the prefetcher nor unwall.app ran. Back on, the prefetcher restarted and re-queued 213 entries
- [x] `AGENTS.md` rule 1's delta count updated (27 code files, 8 topic commits)
